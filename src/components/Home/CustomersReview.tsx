...
export default function CustomersReview() {
    ...
    return (
        <section className="w-full max-w-7xl mx-auto px-6 sm:px-8 py-16 md:py-24 bg-white overflow-hidden">
            <div className="flex flex-col md:flex-row md:items-center md:gap-8 lg:gap-16 xl:gap-24">
                {/* Left column with heading and flower illustration */}
                <div className="md:w-5/12 mb-12 md:mb-0">
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-8 lg:mb-20 leading-relaxed tracking-tight">
                ...
                <div className="md:w-7/12">
                    <div className="relative">
                        {/* Quote mark */}
                        <div className="absolute -left-0 lg:-left-4 bottom-32 lg:bottom-24 text-pink-400 text-7xl md:text-8xl opacity-80 font-serif leading-none">
                            <Image src={comma} width={62} height={62} alt="Comma" className="w-12 lg:w-16 h-12 lg:h-16" />
                        </div>
                        ...
                        <div className="pl-12 pr-4 relative">
                            ...
                            <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-6 text-end">
                                {testimonials[activeIndex].text}
                            </p>
                            <p className="text-sm text-gray-500 text-end">{testimonials[activeIndex].date}</p>
                        </div>
                    </div>
                </div>
